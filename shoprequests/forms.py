...
class ShopRequestForm(forms.ModelForm):
    ...
    class Meta:
        model = ShopRequest
        fields = ("first_name","last_name","age","gender","nationality","country","phone_number","city","state","zip_code","street_address","shop_title","shop_category","shop_address","id_proof","id_proof_img","address_proof","address_proof_img")
